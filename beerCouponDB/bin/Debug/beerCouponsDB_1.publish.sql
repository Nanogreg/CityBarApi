...
GO
ALTER TABLE [dbo].[Users] DROP CONSTRAINT [FK__Users__FkBarId__3F466844];
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Users])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Users] ([Id], [FirstName], [Email], [FkBarId])
        SELECT   [Id],
                 [FirstName],
                 [Email],
                 [FkBarId]
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Users'))
               AND [type] IN (N'F', N'C')
